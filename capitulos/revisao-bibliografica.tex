...
Concluindo que o problema que pertence à classe \emph{NP-Difícil} não é provado ser resolvido em tempo polinomial. Problemas de otimização e combinatória para o \emph{VRP}, como o problema caixeiro viajante,  geralmente, pertencem a classe \emph{NP-Difícil}.
\end{comment}
...
Diferentes soluções podem ser utilizadas para o VRP, que fundamentalmente a literatura os separa entre três principais abordagens: Métodos Exatos, Métodos Heurísticos e Meta-Heurísticos \cite{maxwell}. \begin{comment}
...
\begin{itemize}
    ...
    \begin{comment}
e então, a quota não será levado como prioridade, pois será uma consequência do uso do transporte coletivo compartilhado\end{comment}
